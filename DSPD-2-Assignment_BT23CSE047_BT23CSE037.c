...
struct Vehicle {
    ...
    char owner_name[100]; // Owner name
    time_t arrivaltime; // Arrival time of the vehicle
    time_t departtime; // Departure time of the vehicle
    float totalparking_hours; // Total parking hours use by the vehicle
...
int main() {
    ...
    do {
        ...
        if (choice == 1) {
            ...
            sortVehiclesByParkingCount();//Sort the list of vehicles based on number of parkings done
        } 
        else if (choice == 6) {
            sortAndDisplayVehiclesByRevenue();// Sort the list of vehicles based on parking amount paid
        } 
        else if (choice == 7) {
            sortAndDisplayParkingByOccupancy();//Sort the list of parking spaces based on their occupancy
        } 
        else if (choice == 8) {
            sortAndDisplayParkingByRevenue();//Sort the list of parking spaces which generated maximum revenue. 
        } 
        else if (choice == 9) {
